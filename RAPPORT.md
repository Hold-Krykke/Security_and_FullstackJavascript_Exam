...
#### JWT
Når en bruger er logget ind i vores applikation skal vi bruge en måde at kommunikere dette til vores mobile app. Vi ønsker ikke at sende nogle af de tokens vi får af Google ud til den mobile app, da de giver adgang til den sensitive data Google har om den givne bruger og samtidig ønsker vi at kunne behandle brugere ens, efter login, uanset hvilken måde de er logget ind på. For at løse dette, bruger vi JSON Web Tokens.   
