...
import { StyleSheet, View, Text, TouchableWithoutFeedback, Keyboard, Button, Modal, ActivityIndicator, ScrollView, KeyboardAvoidingView } from "react-native";
...
const UserScreen = ({ visible, user, setUser, username, setUsername, showModal, setSignedIn, navigation, }) => {
                                ...
                                <View style={styles.screen}>
                                    ...
                                    <Card style={styles.container}>
                                        ...
                                        <Input
                                            ...
                                            onChangeText={(input) => { userInputHandler(input); }}
                                        ></Input>
                                        ...
                                        <View style={styles.warningTextContainer}>
                                            <Text style={styles.text}>
                                                ...
                                                then your email will be used as your username, which is public to other users.
                                            </Text>
                                        </View>
                                    </Card>
                                </View>
